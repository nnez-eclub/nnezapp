			...
			<div class="navbar-header">
			 ...
			 <div class="collapse navbar-collapse" id="navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<?php if(check_privilege(PRI_ACCESS_TEXTS))echo '<li id="tag_inbox"><a href="javascript:tag_switch(\'inbox\');"><span class="glyphicon glyphicon-envelope" style="font-size: 19px;">收件箱</span><span class="badge" id="badge_ntexts"><i class=\"icon-spinner icon-spin\"></i></span></a></li>';?>
		      ...
		      <div class="modal-content">
		         ...
		         <div class="modal-footer">
		            ...
		            <button type="button" id="post_button" class="btn btn-primary" onclick="post_text()">
		               <span class="glyphicon glyphicon-send">发送<i id="sending_indicator" class="icon-spinner icon-spin" style="display:none"></i></span>
		            </button>
		         </div>
		      </div><!-- /.modal-content -->
		    </div><!-- /.modal -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<address>
					...
					<p><i class="icon-github"></i>github:<a target="_blank" href="http://github.com/sqd">sqd</a></p>
					<p>------Grade 2013,yh</p>
				</address>
			</div>
			<div class="modal-footer">
